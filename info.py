...
PICS = (environ.get('PICS', 'https://graph.org/file/8245118f9f8611d649d19-d816bf6b8e581b228e.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002421767742))  # fallback ID
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/1e0863f2a6a313c48e363-4670d285fa425a40ba.jpg') # payment code picture url.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'filestore302') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/tamilchatting24x7')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/tamilmovieslatestt')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'tamilchatting24x7') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/tgmaster_pro')
